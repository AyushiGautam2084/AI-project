...
def greedy_best_first_solver(maze, start, end):
    priority_queue = [(heuristic(start[0], start[1], end[0], end[1]), start)]
    visited = set()
    came_from = {}
    ...
    while priority_queue:
        ...
        for dx, dy in directions:
            ...
            if is_valid_move(maze, new_x, new_y) and (new_x, new_y) not in visited:
                ...
                heapq.heappush(priority_queue, (heuristic(new_x, new_y, end[0], end[1]), (new_x, new_y)))
...
def main():
    ...
    path = greedy_best_first_solver(maze, start, end)
